...
const questions = [
  ...
  {
    q: "Do I need to be a CS/DS major to participate?",
    a: ["No. Freshman from any majors are welcome to participate."],
  },
  {
...
const getAnswers = (list) => {
  let content = [];
  if (list.length == 1) {
    content.push(<p className={styles.faq_answerText}>{list[0]}</p>);
  } else {
    content.push(
...
const faqList = getQuestions(questions);
